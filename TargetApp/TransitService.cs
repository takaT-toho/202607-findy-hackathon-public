...
public class TransitService
{
    ...
    public async Task<TrainStatus> FetchStatusAsync()
    {
        ...
        try
        {
            ...
            var dto = JsonSerializer.Deserialize<TransitApiResponse>(raw, options);
    ...
    private record TransitApiResponse(
        ...
        [property: System.Text.Json.Serialization.JsonPropertyName("delays")] TransitDelays? Delays,
        [property: System.Text.Json.Serialization.JsonPropertyName("last_updated")] DateTimeOffset LastUpdated);

    private record TransitDelays(
